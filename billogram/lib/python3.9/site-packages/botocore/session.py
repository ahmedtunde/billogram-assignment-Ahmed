...
from botocore import (UNSIGNED, __version__, handlers, monitoring, paginate,
                      retryhandler, translate, utils, waiter)
...
from botocore.exceptions import (ConfigNotFound, PartialCredentialsError,
                                 ProfileNotFound, UnknownServiceError)
