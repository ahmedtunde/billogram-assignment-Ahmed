...
from etc.templatetags.gravatar import gravatar_get_img, gravatar_get_url
from etc.templatetags.model_meta import (model_meta_verbose_name,
                                         model_meta_verbose_name_plural)
from etc.toolbox import (choices_list, get_choices,
                         get_model_class_from_settings,
                         get_model_class_from_string, get_site_url,
                         import_app_module, import_project_modules,
...
class TestChoices:
    ...
    def test_enum(self):
        ...
        from etc.tests.testapp.models import MyChoiceModel, Role, Variant
