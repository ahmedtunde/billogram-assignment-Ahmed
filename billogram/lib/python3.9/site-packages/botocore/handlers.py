...
from botocore.compat import (MD5_AVAILABLE, ETree, OrderedDict, XMLParseError,
                             ensure_bytes, get_md5, json, six, unquote,
                             unquote_str, urlsplit, urlunsplit)
from botocore.docs.utils import (AppendParamDocumentation, AutoPopulatedParam,
                                 HideParamFromOperations)
from botocore.exceptions import (AliasConflictParameterError,
                                 MissingServiceIdError, ParamValidationError,
                                 UnsupportedTLSVersionWarning)
from botocore.signers import (add_generate_db_auth_token,
                              add_generate_presigned_post,
                              add_generate_presigned_url)
from botocore.utils import (SAFE_CHARS, conditionally_calculate_md5,
                            hyphenize_service_id, percent_encode,
